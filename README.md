...
1. Project Overview
•	Retail Sales, Product and Customer Dataset (ID, Order date, Name, Year, Category, Sub category, Loyalty status, Country, Gender, Age, Supplier, Region, Discount, Quantity) The objective is to create an interactive Sales Analysis Dashboard in Power BI that answers;

o	Which product generates the most revenue?
o	Which country contributes most to revenue?
o	Who are the top customers and what drives their loyalty?
o	How does sales trends vary by region, category and time?
o	Which product category contributes most to growth?
2. Data Collection
...
•	Formatted columns:
o	Dates ↔ Date format
o	Price / Cost↔ Currency format
	Handle missing values: Replaced with unknown or average where applicable
	Merged Queries:
o	Merged Sales with Products on Product ID
o	Merged sales with customers on Customer ID
Added calculated columns:
o	Revenue = Quantity * Unit price (1 – Discount / 100)
o	
   4.The Dashboards
...
2. Capitalize on Best Selling Category 
•	Expand the furniture product line or introduce premium product versions.
•	Bundle furniture with complementary items to increase order value. 
...
4. Increase Inventory for High Demand Months
April shows a peak. Prepare inventory and promotional activities ahead of this period to maximize sales.
5. Customer Profiling for Personalization
